...
public abstract class Calculator {
    ...
    /**
     * Метод задает новое значение строки содержащей выражение
     * @param input - неотформатированная строка, содержащая исходное выражение
     */
    ...
    public abstract double parser(String input);

    public abstract String numberToString(Double d);
    ...
    public void exponent() {
        ...
        for (int i = 0; i < calculateString.length(); i++) {
            ...
            if (calculateString.charAt(i) == '^') {
                ...
                System.out.println(Arrays.toString(charsPosition));

                a = parser(calculateString.substring(startPosition, i));
                System.out.println(a);
                System.out.println(finishPosition);
                System.out.println(calculateString);
                b = parser(calculateString.substring(i + 1, finishPosition));
                ...
                calculateString.insert(startPosition, numberToString(c));
